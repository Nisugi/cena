...
| `plan/37-spell-behaviors.md` | **spellactive, ewaggle, spellcaster**: measured and staged; Stage 1 BUILT (what the spell table dropped, joined back: `cena-model/src/spells/extras.rs`) |
