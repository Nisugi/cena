...
pub(crate) fn get(name: &str) -> Option<(&'static str, &'static str)> {
    let text = match name {
        ...
        "hunting-catalogue.mjs" => include_str!("../assets/atlas/hunting-catalogue.mjs"),
        "hunting-destinations.mjs" => include_str!("../assets/atlas/hunting-destinations.mjs"),
        ...
        "rest-picker.mjs" => include_str!("../assets/atlas/rest-picker.mjs"),
