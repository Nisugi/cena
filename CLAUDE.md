...
| `plan/31-eloot-port.md` | **M6c**: eloot measured and ordered; Stages 1-3 (the hunt's share), skinning and Stages 4a-4b (the selling round during the rest: gem shop, pawnshop, furrier, collectibles, Chronomage, bank) BUILT; 4c the locksmith pool next |
