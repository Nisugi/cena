...
> 2026-09-24); Stage 4 (selling during the rest) is next, by the author's call to finish
> eloot before M6d. **`plan/34`** stages the author's `loottracker.lic` as the loot ledger: the
