...
| `plan/36-eherbs-port.md` | **the Heal behavior**: eherbs measured and staged; Stage 1 BUILT (the 247-herb table in `cena-model/src/herbs.rs`, the dose monitor `state/doses.rs`); healing, the survival kit and distiller, and stocking next |
